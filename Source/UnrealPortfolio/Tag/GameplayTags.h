...
#define TAG_COUNTER_ATTACK FGameplayTag::RequestGameplayTag(FName("Character.Action.CounterAttackPossible"))
#define TAG_COUNTER_HIT FGameplayTag::RequestGameplayTag(FName("Character.Action.CounterHitPossible"))
